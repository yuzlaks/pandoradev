            ...
            <div class="main_menu">
            	<nav class="navbar navbar-expand-lg navbar-light">
					<div class="container box_1620">
						...
						<a class="navbar-brand logo_h" href="index.html"><img src="{{ asset('img/icon.png') }}" width="25" alt=""></a>
					...
					<div class="row">
						...
						<div class="col-lg-7">
							<div class="home_left_img">
								<img class="img-fluid" src="{{ asset('img/icon.png') }}" width="200px" alt="">
							</div>
						</div>
					</div>
				</div>
							...
							<div class="row made_life_text">
								<div class="col-lg-6">
									<div class="left_side_text">
										...
										<a class="main_btn" href="{{ url('docs-pmint') }}">Dokumentasi</a>
									</div>
								</div>
								<div class="col-lg-6">
									<div class="chart_img">
